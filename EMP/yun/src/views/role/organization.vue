            ...
            <div class="col-right">
                <Card>
                    ...
                    <Form :label-width="80">
                        ...
                        <FormItem label="编号">
                            <Input v-model="search.number"/>
                        </FormItem>
                        <FormItem label="名称">
                            <Input v-model="search.name"/>
                        </FormItem>
                        <Button type="primary" class="submit" style="margin-left:100px;" @click="handleSearch">查询</Button>
                    </Form> 
                </Card>
            </div>
        </Row>
            ...
            <div class="col-right">
                <Card class="table-card">
                    <div style="padding-bottom:10px;">
                        ...
                        <Modal v-model="newModel" title="新增部门" width="600">
                            <div>
                                <Form :label-width="100">
                                    <FormItem label="上级组织名称">
                                        <Input disabled v-model="organize.name"/>
                                    </FormItem>
                                    <FormItem label="上级组织ID" class="half">
                                        <Input disabled v-model="organize.number"/>
                                    </FormItem>
                                    <FormItem label="上级组织序号" class="half">
                                        <Input disabled value="10"/>
                                    </FormItem>
                                    <FormItem label="上级组织名称">
                                        <Select value="部门" v-model="createOrUpdate.organizeState"><Option value="部门">部门</Option></Select>
                                    </FormItem>
                                    <FormItem label="组织名称">
                                        <Input v-model="createOrUpdate.name"/>
                                    </FormItem>
                                    <FormItem label="组织序号">
                                        <Input  v-model="createOrUpdate.number"/>
                                    </FormItem>
                                </Form> 
                            </div>
                            <div slot="footer">
                                <Button @click="newModel = false">取消</Button>
                                <Button type="primary" @click="handleCreate">保存</Button>
                            </div>
                        </Modal>

                        <Button type="primary" @click="handleUpdateModal">修改</Button>
                        <Modal v-model="editModel" title="编辑部门" width="600">
                            <div>
                                <Form :label-width="100">
                                    <FormItem label="上级组织名称">
                                        <Input disabled v-model="organize.name"/>
                        ...
                        <Modal v-model="deleteModel" title="删除部门" width="350" class="confirmModel">
                            <div>
                                <p>确定删除吗？</p>
                            </div>
                        </Modal>
        ...
        data () {
            return {
                ...
                columns: [  // 表头
                    ...
                    {title:'编号',key:'number',width: 90},
                    {title:'层级',key:'grade',width: 50},
                    {title:'名称',key:'name',width: 100},
                    {title:'备注',key:'remark',width: 100},
                    {title:'上级组织机构',key:'parentorg',width: 200},
                    {title:'上级编号',key:'parentnum',width: 100},
                    {title:'创建人',key:'createuser',width: 100},
                    {title:'创建人所属机构',key:'createfrom',width: 200},
                    {title:'创建时间',key:'createtime',width: 200},
                    {title:'更新人',key:'updateuser',width: 120},
                    {title:'更新人所属机构',key:'updatefrom',width: 200},
                    {title:'更新时间',key:'updatetime',width: 200},
                ],
                data: [
                    {number:1,grade:1,name:1,remark:1,parentorg:1,parentnum:1,createuser:1,createfrom:1,createtime:1,updateuser:1,updatefrom:1,updatetime:1,},
                    {number:2,grade:2,name:2,remark:2,parentorg:2,parentnum:2,createuser:2,createfrom:2,createtime:2,updateuser:2,updatefrom:2,updatetime:2,},
                    {number:3,grade:3,name:3,remark:3,parentorg:3,parentnum:3,createuser:3,createfrom:3,createtime:3,updateuser:3,updatefrom:3,updatetime:3,},
                ],
